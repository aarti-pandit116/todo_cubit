    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Color.lerp(task.backgroundColor, Colors.white, 0.3), // Make color lighter
        ...
        child: Row(
          ...
          children: [
            ...
            if (task.title.toLowerCase().contains('coffee') || task.title.toLowerCase().contains('meet'))
              const Icon(
